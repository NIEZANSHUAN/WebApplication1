...
//                    HttpContext.Session.SetString("UserId", userId.ToString());//存入Session
...
//                    return Json(new { code = 200, msg = "员工页面", redirectUrl = Url.Action("index", "Home", new { area = "Admin" }) });
//                }
//                else if (dropdown == 102)
//                {
//                    return Json(new { code = 200, msg = "管理员页面", redirectUrl = Url.Action("index", "Home", new { area = "Admin" }) });
//                }
